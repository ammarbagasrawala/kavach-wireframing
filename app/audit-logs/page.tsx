                        ...
                        <div className="overflow-x-auto">
                            <div className="min-w-[800px]">
                                <table className="w-full text-left">
                                    <thead className="bg-[var(--background)] border-b border-[var(--border)] text-[11px] font-700 text-[var(--muted-foreground)] uppercase tracking-wider">
                                        <tr>
                                    ...
                                    <tbody className="divide-y divide-[var(--border)]">
                                        {filteredLogs.length > 0 ? (
                                            filteredLogs.map((log) => (
                                                <tr key={log.id} className="hover:bg-[var(--muted)]/30 transition-colors group">
                                                    <td className="px-6 py-4">
                                                        <div className="flex items-center gap-3">
                                                            <div className="w-8 h-8 rounded-full bg-[var(--primary-500)]/5 flex items-center justify-center text-[var(--primary-500)] group-hover:scale-110 transition-transform">
                                                    ...
                                                    <td className="px-6 py-4">
                                                        <div className="flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-[var(--color-success-700)]/10 w-fit">
                                                    ...
                                                    <td className="px-6 py-4 text-right">
                                                        <span className="text-[12px] text-[var(--muted-foreground)] italic whitespace-nowrap">{log.details}</span>
                                                    </td>
                                                </tr>
                                            ))
                                        ) : (
