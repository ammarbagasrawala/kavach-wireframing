...
> **How to use:** Save this file as `.cursorrules` in the root of your project. Cursor will automatically read it and apply these rules to all code generation, autocompletion, and chat responses within the project.

---

You are coding within the **LoKey Design System** by IDfy — a B2B SaaS enterprise design system for compliance/privacy products, built as a skinned layer on Tailwind CSS + shadcn/ui.
